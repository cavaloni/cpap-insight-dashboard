...
import { ingestCPAPStreamingCSV } from '@/lib/data/streaming-ingest';
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Ingest the data using streaming pipeline (Parquet + SQLite)
    const result = await ingestCPAPStreamingCSV(tempFilePath);
